...
| `ads_resolve_creative_assets` | Resolve ranked thumbnail URL candidates (image hash, video thumbnail, Instagram media) per ad | Meta implemented; Google/TikTok return structured `NOT_IMPLEMENTED` |
