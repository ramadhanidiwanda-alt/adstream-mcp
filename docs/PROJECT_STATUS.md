...
| **Meta v25 objective launch baseline** | Six ODAX objectives with canonical destination validation, PAUSED creation/read-back flow, v23/v24/v25 compatibility, and CPAS catalog v25 regression coverage | Full suite passes (75 files / 1052 tests); no live contract test or activation run                                       | ✅ Done                                             |
