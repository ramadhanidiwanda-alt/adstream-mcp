...
| **Phase 20B.1-2** | Cuan Insight OAuth persistence schema + RPC    | mcp*oauth*\* tables, resolve_mcp_oauth_token_credential RPC, Edge Function extension                                                                  | ✅ Done (cuán-insight PR #59, #60) |
