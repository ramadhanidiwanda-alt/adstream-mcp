  ...
  return {
    ...
    properties: {
      ...
      welcomeMessageTemplateName: {
        type: 'string',
        description:
          'Nama reusable welcome message template lokal dari ads_list_welcome_message_templates. Saat diisi, template dikembangkan menjadi creativeSpec.pageWelcomeMessage sebelum creative dibuat. Jangan isi bersamaan dengan creativeSpec.pageWelcomeMessage. Berlaku untuk creativeFormat yang mendukung pageWelcomeMessage. Khusus existing_post, jangan pakai untuk Click-to-WhatsApp karena Meta menolak page_welcome_message pada jalur existing-post CTWA; gunakan native single_image/video CTWA, clone Ads Manager tanpa creative override, atau Ads Manager UI.',
      },
