...
const PRESETS: Record<MetaLaunchWorkflow, LaunchPresetDefinition> = {
  ...
  sales_messaging: {
    ...
    safetyNotes: [
      ...
      'Default Sales CTWA tetap CONVERSATIONS untuk percakapan. Jika user meminta target kinerja pembelian melalui pesan, isi optimizationGoal OFFSITE_CONVERSIONS plus pixelId dan customEventType PURCHASE; jangan fallback diam-diam ke CONVERSATIONS.',
